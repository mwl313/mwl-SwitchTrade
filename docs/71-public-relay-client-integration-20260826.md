...
5. Qualify both RTL8192EU adapters and the two-PC/two-WSL/two-Switch production path, including both
   creator assignments, full trade/save/exit, immediate reuse, party display, and WAN impairment.
6. Archive the exact build inputs/checksums and record written private-beta approval.
