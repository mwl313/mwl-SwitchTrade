"""CLI entry point for installed-runtime direct Switch room admission (A0-A9)."""
...
def parser() -> argparse.ArgumentParser:
    ...
    value = argparse.ArgumentParser(description="SwitchTrade direct A0-A9 qualification harness")
