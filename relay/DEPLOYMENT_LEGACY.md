# Historical private-beta Room relay deployment handoff

**Not the Simple Architecture deployment instructions.** Use [DEPLOYMENT.md](DEPLOYMENT.md)
for Core. The commands below describe the old Room deployment at source
`156b9da6348a2b082dd12318bb63320cc19e44c5`; they must not be run against the new
default Dockerfile/Compose. Legacy server source is retained, not mounted by Core.
